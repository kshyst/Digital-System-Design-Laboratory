...
% pstricks is omitted because this report uses only raster figures.
...
% Algorithm packages are omitted because this report defines no algorithm floats.
...
\providecommand{\psscalebox}[1]{}  % for LaTeX Draw
